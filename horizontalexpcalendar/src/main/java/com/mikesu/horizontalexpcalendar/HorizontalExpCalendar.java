...
public class HorizontalExpCalendar extends RelativeLayout implements PageView.PageViewListener, Animations.AnimationsListener, View.OnClickListener {
  ...
  private void init(AttributeSet attributeSet) {
    ...
    findViewById(R.id.collapse_button).setOnClickListener(this);
  }
  ...
  private void setCellHeight() {
    Config.cellHeight=90;// = Config.monthViewPagerHeight / (Config.MONTH_ROWS + Utils.dayLabelExtraRow());
  }
  ...
  ImageButton imageButtonNext,imageButtonPrevios;
  private void initTopContainer() {
    titleTextView = (TextView) findViewById(R.id.title);


    imageButtonNext = findViewById(R.id.nxtIB);

    imageButtonPrevios = findViewById(R.id.privesIB);



    imageButtonPrevios.setOnClickListener(new OnClickListener() {
      @Override
      public void onClick(View view) {

        int i = titleDate.getMonthOfYear() - 1;
        weekViewPager.setCurrentItem(weekViewPager.getCurrentItem()-1);
        //  Log.e("aa",weekViewPager.getCurrentItem()+"");
        refreshTitleTextView();
    ...
    imageButtonNext.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View view) {
        ...
        int i = titleDate.getMonthOfYear() + 1;
       // String monthForInt = getMonthForInt(i);
  ...
  private void refreshTitleTextView() {
    ...
    int monthOfYear = titleDate.getMonthOfYear();
    Log.e("QQQ",""+monthOfYear);
    String month = getMonthForInt(monthOfYear);
    titleTextView.setText(String.format("%s   %s", month , titleDate.getYear()));
